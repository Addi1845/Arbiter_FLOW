...
def clean_text(text: str) -> str:
    """
    Cleans extracted text by stripping whitespace, normalizing newlines/spaces,
...
def parse_pdf(file_bytes: bytes) -> dict:
    """
    Parses a PDF file from bytes, falling back to OCR for scanned pages,
    and returns its extracted text and metadata.
    """
    try:
    ...
    for page_num in range(total_pages):
        ...
        # Method A: Try digital extraction
        try:
